...
class _UserInfoState extends State<UserInfo> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: _isTablet ? _isPortrait ? const EdgeInsets.symmetric(vertical: 64.0) : const EdgeInsets.all(0.0) : const EdgeInsets.all(0.0),
      child: Row(
        ...
        children: [
          ...
          Container(
              ...
              width: _isTablet ? _isPortrait ? MediaQuery.of(context).size.width : MediaQuery.of(context).size.width / 2 : _isPortrait ? MediaQuery.of(context).size.width : MediaQuery.of(context).size.width/2,
              child: Padding(
