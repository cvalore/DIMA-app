...
void main() {
  testWidgets("ViewBookPage Test", (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(home: Scaffold(body: StreamProvider(
      ...
      child: Builder(builder: (BuildContext context) {
        return ViewBookPage(key: _childKey, book: book, index: 0, hadImages: false, wasExchangeable: true, fatherContext: context, self: true, userUid: "", thumbnail: "", canBuy: false,);
      },),
    ),),));
    ...
    expect(find.byType(Exchange), findsOneWidget);
    ...
    await tester.pumpWidget(MaterialApp(home: Scaffold(body: StreamProvider(
      ...
      child: Builder(builder: (BuildContext context) {
        return ViewBookPage(key: _childKey, book: book, index: 0, hadImages: false, wasExchangeable: true, fatherContext: context, self: false, userUid: "", thumbnail: "", canBuy: true,);
      },),
    ),),));
